...
namespace UnitySharpNEAT
{
    ...
    /// </summary>
    public class NeatSupervisorCar : MonoBehaviour
    {
        #region FIELDS
        ...
        public ExperimentCar ExperimentCar { get; private set; }
        #endregion
        ...
        private void Start()
        {
            ...
            ExperimentCar = new ExperimentCar();
            ExperimentCar.Initialize(xmlConfig.DocumentElement, this, _networkInputCount, _networkOutputCount);

            ExperimentIO.DebugPrintSavePaths(ExperimentCar);
        }
        #endregion
        ...
        public void StartEvolution()
        {
            ...
            EvolutionAlgorithm = ExperimentCar.CreateEvolutionAlgorithm(ExperimentIO.GetSaveFilePath(ExperimentCar.Name, ExperimentFileType.Population));
        ...
        public void RunBest()
        {
            ...
            NeatGenome genome = ExperimentCar.LoadChampion();
            if (genome == null)
                return;

            // Get a genome decoder that can convert genomes to phenomes.
            IGenomeDecoder<NeatGenome, IBlackBox> genomeDecoder = ExperimentCar.CreateGenomeDecoder();
        ...
        void HandlePauseEvent(object sender, EventArgs e)
        {
            ...
            ExperimentCar.SavePopulation(EvolutionAlgorithm.GenomeList);
            ExperimentCar.SaveChampion(EvolutionAlgorithm.CurrentChampGenome);
