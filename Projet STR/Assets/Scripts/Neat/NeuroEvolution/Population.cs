...
namespace NEAT
{
    ...
    { 
        ...
        public Genotype Breed()
        {
            ...
            {
                int s1 = UnityEngine.Random.Range(0, members.Count);
                int s2 = UnityEngine.Random.Range(0, members.Count-1);
    ...
    public class Population
    {
        ...
        public void NewGeneration()
        {
            ...
            {
                Genotype child = species[UnityEngine.Random.Range(0, species.Count)].Breed();
                children.Add(child);
            }
