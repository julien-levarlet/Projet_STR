...
namespace NEAT
{
    ...
    public class Mutation
    {
        ...
        public void MutateAll(Genotype genotype)
        {
            ...
            while (p > 0)
            {
                float roll = (float)UnityEngine.Random.Range(0f,1f);
        ...
        public void MutateLink(Genotype genotype)
        {
            ...
            for (int i = 0; i < vertexCount; i++)
            {
                for (int j = 0; j < vertexCount; j++)
                {
                    ...
                    if (!search)
                    {
                        float weight = UnityEngine.Random.Range(-2f, 2f);
            ...
            int selection = UnityEngine.Random.Range(0, potential.Count);
        ...
        public void MutateNode(Genotype genotype)
        {
            ...
            int selection = UnityEngine.Random.Range(0, edgeCount);
        ...
        public void MutateEnable(Genotype genotype)
        {
            ...
            int selection = UnityEngine.Random.Range(0, candidates.Count);
        ...
        {
            int selection = UnityEngine.Random.Range(0, genotype.edges.Count);
        ...
        {
            float scalar = UnityEngine.Random.Range(0f, 1f) * step - step * 0.5f;
            edge.weight += scalar;
        }

        public void MutateWeightRandom(EdgeInfo edge)
        {
            float value = UnityEngine.Random.Range(0f, 1f) * 4.0f - 2.0f;
            edge.weight = value;
        }
    }
}
